...
class VAR(nn.Module):
    def __init__(
        ...
        # self.vae_proxy = nn.ModuleList([vae_local])   # 用ModuleList
        # self.vae_quant_proxy = [vae_local.quantize]   # 不是Module，可以用list
    ...
    def forward(
        ...
        endtime = time.time() - detime
        print("decoder_time:{}ms".format(endtime*1000))    
        return result
