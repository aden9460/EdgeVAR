...
class AdaLNSelfAttn(nn.Module):
    def __init__(
        ...
        hidden_features=round(round(embed_dim * mlp_ratio)*(1-args.sparsity))
        # self.ffn = FFN(in_features=embed_dim, hidden_features=round(embed_dim * mlp_ratio), drop=drop, fused_if_available=fused_if_available)
        self.ffn = FFN(in_features=embed_dim, hidden_features=hidden_features, drop=drop, fused_if_available=fused_if_available)
